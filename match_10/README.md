...
| 题号 | 题目 | 关键技术 | 目录 |
|:---:|------|---------|------|
| 10 | JS 混淆 - 重放攻击对抗 | JSDOM 运行时还原、XHR 拦截、k 值回写 | [match_10](./match_10/) |
...
- **Node.js** - 运行环境
- **JSDOM** - 在 Node 中模拟浏览器 DOM 环境
- **jQuery** - 复用页面原有的 AJAX 请求逻辑
...
本项目仅供**学习交流**使用，用于研究 JavaScript 逆向工程和反爬虫技术。请勿用于任何商业用途或违反目标网站服务条款的行为。使用本项目所产生的一切后果由使用者自行承担。
